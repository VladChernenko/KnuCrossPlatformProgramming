...
namespace Lab4ClassLibs
{
    public class Lab1
    {
        ...
        public static void Lab1Execution(string inputFileName,string outputFileName)
        {
            ...
            try
            {
                ...
                Console.WriteLine("Prime divisors are " + string.Join(", ", primeDivisors));

                // List the unique values
                List<int> uniquePrimeDivisors = primeDivisors.Distinct().ToList();
                Console.WriteLine("Unique prime divisors are " + string.Join(", ", uniquePrimeDivisors));
                ...
                Console.WriteLine("Their production: " + productionOfUnique);
