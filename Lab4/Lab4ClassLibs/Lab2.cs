...
namespace Lab4ClassLibs
{
    ...
    public class Lab2
    {
        public static void Lab2Execution(string inputPath, string outputPath)
        {
            string word;
            int K;
            ...
            FindAlmostPalindromes(subwords, K, outputPath);
        }
        ...
        static void FindAlmostPalindromes(List<string> subwords, int K,string outputPath)
        {
